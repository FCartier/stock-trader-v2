        ...
        <div>
          ...
          <Switch>
            ...
            <Route
              ...
              component={getData(Overview, StyledContainer)}
            />
            <Route
              path="/:symbol/chart"
              component={getData(Chart, StyledContainer)}
            />
            <Route
              path="/:symbol/peers"
              component={getData(TopPeers, StyledContainer)}
            />
            <Route
              path="/:symbol/keystats"
              component={getData(KeyStats, StyledContainer)}
            />
            <Route
              path="/:symbol/news"
              component={getData(News, StyledContainer)}
            />
