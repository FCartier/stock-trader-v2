...
const unformattedSearchData: UnformattedData[] = 
[
    {
      symbol: "A",
    ...
    {
      symbol: "ARES-A",
      name: "Ares Management L.P. 7.00% Series A Preferred Shares Representing Limited Partner Interests",
      date: "2018-10-03",
      isEnabled: true,
      type: "ps",
      iexId: "11483"
...
export default unformattedSearchData;